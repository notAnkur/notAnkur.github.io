  ...
  render() {
    ...
    return (
      <div className="has-text-centered">
        <section
          className="hero is-info is-large header-radius hero-img"
          id="home"
        >
                ...
                <div id="navbarMenuHeroB" className="navbar-menu">
                  <div className="navbar-end nav-col top-margin-navbar">
                    <Scroll type="id" element="home" timeout={80}>
                      <a
                        href="#home"
                        className="navbar-item onC is-active"
                        id="homeId"
                      >
                        Home
                      </a>
                    ...
                    <a
                      href="https://notankur.artstation.com/"
                      target="_blank"
          ...
          <div className="hero-body hero-bg header-radius">
            <div className="hero-bg-overlay">
              <div className="container has-text-centered">
                <h1 className="title title-l">Ankur Anant</h1>
                <div className="text-wrapper">
                  <div className="animated-words title-m h-anim">
                    ...
                    <span>Making bots beep boop</span>
                  </div>
                </div>
              </div>
            </div>
